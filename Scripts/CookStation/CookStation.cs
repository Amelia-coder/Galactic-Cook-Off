...
//			if (Input.IsActionJustPressed("add_piece_to_kitchen"))
//			{
//				InsertGoods();
//			}
//		}
...
//				GD.Print("Press F to insert goods");
//			}
//		}
...
//		{
//			// TEMPORARY:
//			// emulate player giving 1 good

//			_storedGoods++;

//			GD.Print($"Goods: {_storedGoods}/{RequiredGoods}");
...
//		private async void StartFakeMiniGame()
//		{
//			GD.Print("Starting fake minigame...");

//			await ToSignal(GetTree().CreateTimer(3.0), "timeout");

//			GD.Print("Fake minigame completed!");
